...
psql -h %server_host% -p %server_port% -U %psql_user% -d %Database_name% -c "CREATE TABLE %schema_name%.Login_Details (Email VARCHAR(255),Password VARCHAR(255),JWT VARCHAR(255),Preferences JSON);"
