...
// export const Tabs_Sec_Popup = () => {
  export const Tabs_Sec_Popup = ({ supplierVisibilityValue , specVisibilityValue, itemVisibilityValue,selectedRData}) => {
...
} else if (specVisibilityValue === true) {
  tabs = [
    { name: "Part Detail(s)", icon: "/assets/part.png" },
    { name: "Specification(s)", icon: "/assets/specification.png" },
  ];
...
const [availableAttributes, setAvailableAttributes] = useState([
  'Name',"Policy","Owner", 'State', 'Rev','File name', 'Synopsis', 'Description', // Default attributes
]);
...
{/* ------------------------------------------------------------------------------------------------------------ */}
      ...
      <TabPanel>
        <Tab_PartDetails selectedRow={selectedRData}/>
      </TabPanel>
