    ...
    //   setCurrentObjectid(objectId);
      ...
      if (partDataKey) {
        ...
        if (partData) {
          ...
          try {
            const res = await fetch(`http://localhost:8081/Supplierportal/webapi/SupplierPortal/ebomdetails?fromid=${objectId}&connattributes=true`);
...
// -----------------------------------------------Helper Functionss--------------------
    useEffect(() => {
      ...
      const fetchChildData = async (parentObjectId) => {
        try {
          const response = await fetch(`http://localhost:8081/Supplierportal/webapi/SupplierPortal/ebomdetails?fromid=${parentObjectId}&connattributes=true`);
